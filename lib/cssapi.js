 ...
 * @param  {String} component Component's name
 * @param  {String} file      File where the CSS properties will be searched
 */
const updateCSSDocs = (component, file) => {
  getCSSApiFromHtml(component)
    .then(result => mergeResult(getCSSApi(component, file), result))
